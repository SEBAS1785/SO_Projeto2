...
def boarding_worker(
    ...
    # Regista resultado para o processo passageiro verificar
...
def airport_server(
    ...
    # Controlo dos IDs dos portões e agentes em uso
    ...
    while not stop_event.is_set():
        ...
        while True:
            ...
            # Tenta adquirir portão e agente (não bloqueante)
    ...
    # Aguarda que todos os embarques activos terminem
