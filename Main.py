...
def run_simulation(high_demand: bool = False):
    ...
    for pid in range(1, NUM_PASSENGERS + 1):
        ...
        if high_demand:
            ...
            time.sleep(
                random.uniform(ARRIVAL_INTERVAL * 0.5, ARRIVAL_INTERVAL * 1.5)
            )
    ...
    # Sinaliza ao servidor para encerrar quando fila estiver vazia
    stop_event.set()
    ...
    # Guardar estatísticas para a GUI (gráfico)
    stats = {
